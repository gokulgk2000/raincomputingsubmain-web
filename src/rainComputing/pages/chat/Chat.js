...
const SubGroups = lazy(() =>
  import("../../../../src/rainComputing/components/chat/SubGroups")
);
                            ...
                            {currentAttorney ? (
                              filteredCases
                                ...
                                .sort((a, b) => {
                                  ...
                                  return notifyCountDiff !== 0
                                    ? notifyCountDiff
                                    : 0; // Return 0 if notifyCountDiff is 0
                                })
                              ...
                              <>
                                {allCases
                                  .map((caseData) => ({
                                    caseData,
                                    notifyCount: notifyCountforCase(
                                      caseData._id
                                    ),
                                  }))
                                  .sort((a, b) => {
                              ...
                              <ul className="list-inline user-chat-nav d-flex justify-content-sm-end text-end mb-0">
                                ...
                                >
                                  <Dropdown
                                    ...
                                    toggle={() =>
                                      toggleChatSettingOpen(!chatSettingOpen)
                                    }
